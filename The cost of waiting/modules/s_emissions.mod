...
# mip-v3: includes the CCS backup-boiler NG fuel (regen steam beyond the waste-
# heat pool): fuel GJ = steam/boiler_eff, at ng_co2_gj tCO2/GJ. EMITTED, never
# captured (excluded from the capturable bases in q_carbon_capture.mod).
