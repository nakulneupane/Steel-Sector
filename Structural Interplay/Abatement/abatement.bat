...
rem ============================================================================
rem ABATEMENT ANATOMY: common frozen-structure Baseline + six policy scenarios,
rem each perturbing ONE dial from the central case (NG 10, scrap 6%, Medium
rem ramp, cap 1.8, H2 2030, thetas 0.5):
rem   EF1.6 (cap 1.6) | EF1.8 (= central) | S4 (scrap 4%) | S6 (= central)
rem   RL (ramp 10 Mt / 4 Mt H2) | RH (ramp 20 Mt / 8 Mt H2)
rem Yearly rows -> results\abatement_yearly.csv; abatement_pivot.py builds the
rem workbook (cumulative wedge split H2/CCS/scrap/NG/grid/others + abatement
rem cost, sigma_base referencing), abatement_plot.py the seven-bar figure.
rem ============================================================================
