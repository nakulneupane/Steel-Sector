...
# mip-v3: BOF metallic balance. Total metallic charge is n3_metallic_bof (1.1 t/tCS);
# blended scrap (a banded flow decision, e_bof.mod) displaces hot metal
# one-for-one, so the blast furnace supplies the remainder. At the 2025 baseline
# blend (phi0_bof = 9%) this gives ~1.0 t hot metal per tCS (the old calibration).
