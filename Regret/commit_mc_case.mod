# ============================================================================
# COMMIT-MC -- multi-world evaluation / epoch template. Identical semantics
# to commit_case.mod (floors + financial H2, HANDOFF section 3) but the
# world is TOKENIZED instead of fixed: driven by commit_mc_run.py over the
# standard seeded MC worlds (first N draws per H2-arrival cloud).
#
# Tokens: THETATECHVAL THETAGCVAL SCRAPRATEVAL NGPRICEVAL CCOALFILE
#         NGAVAILFILE  -- the realized world (market observables; revealed
#                         by the first review, so epoch solves use them)
#         H2READYVAL   -- H2 debut this solve plans with (realized, or the
#                         epoch-A belief per the roll-forward rule)
#         TSTARVAL     -- floor horizon (2051 norec / 2035 / 2045 / 2025 PF)
#         PLANFILE DUMPOUT -- as in commit_case.mod
# The commitment programs themselves are UNCHANGED (plans/plan_c<Y>.mod,
# signed under the single-world study's belief backdrop).
# ============================================================================
reset;
...
# --- H2-supply commitment is FINANCIAL, not physical ------------------------
...
# REGROW: identical fields to commit_case.mod (incl. achieved intensity)
